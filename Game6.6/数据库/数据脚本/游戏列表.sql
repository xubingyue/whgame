...
-- 棋类游戏
INSERT GameKindItem (KindID, TypeID, KindName, ProcessName, MaxVersion, SortID, Nullity, DataBaseName) VALUES ( 506, 2, '中国象棋', 'ChinaChessVD.exe', 67078, 100, 0, 'QPTreasureDB')
...
INSERT GameKindItem (KindID, TypeID, KindName, ProcessName, MaxVersion, SortID, Nullity, DataBaseName) VALUES ( 528, 2, '大众麻将', 'SparrowDZVD.exe', 67078, 100, 0, 'QPTreasureDB')
...
INSERT GameKindItem (KindID, TypeID, KindName, ProcessName, MaxVersion, SortID, Nullity, DataBaseName) VALUES ( 135, 2, '四川斗地主', 'LandSCVD.exe', 67078, 100, 0, 'QPTreasureDB')
...
INSERT GameKindItem (KindID, TypeID, KindName, ProcessName, MaxVersion, SortID, Nullity, DataBaseName) VALUES ( 529, 2, '牛牛', 'OxVD.exe', 67078, 100, 0, 'QPTreasureDB')
