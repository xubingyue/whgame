...
-- 执行逻辑
BEGIN
	INSERT GameTreasureDBLink.GameTreasureDB.dbo.RecordFlowerGrant(SendUserID,RcvUserID,KindID,ServerID,FlowerName,FlowerCount,FlowerPay,SendUserLoveliness,RcvUserLoveliness,GrantIP)
