...
BOOL CDlgRegister::OnInitDialog()
{
	...
	m_LineRegWeb.SetHyperLinkUrl(TEXT("http://www.sxjingji.cn"));
	m_LineMainPage.SetHyperLinkUrl(TEXT("http://www.sxjingji.cn"));
	m_LinePassWord.SetHyperLinkUrl(TEXT("http://www.sxjingji.cn"));
...
BOOL CDlgLogon::OnInitDialog()
{
	...
	m_BrowerAD.Navigate(TEXT("http://www.sxjingji.cn/AD/LogonAD.asp"),NULL,NULL,NULL,NULL);
	...
	//设置控件
	m_LineMainPage.SetHyperLinkUrl(TEXT("http://www.sxjingji.cn"));
	m_LinePassWord.SetHyperLinkUrl(TEXT("http://www.sxjingji.cn/Passwordprotection.asp"));
	m_LineGetPassWord.SetHyperLinkUrl(TEXT("http://www.sxjingji.cn/FindPassWord.asp"));
...
{
//#ifndef _DEBUG
//	ShellExecute(NULL,TEXT("open"),TEXT("http://www.sxjingji.cn/service/viewrule.jsp"),NULL,NULL,SW_SHOWDEFAULT);
//	return;
//#endif
	...
	//服务器
	GetDlgItemText(IDC_SERVER,m_strLogonServer);
	if (m_strLogonServer.IsEmpty()) m_strLogonServer=TEXT("www.yjkj.net");
