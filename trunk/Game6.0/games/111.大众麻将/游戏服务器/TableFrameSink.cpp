	...
	case GER_NORMAL:		//常规结束
		{
			...
			for (WORD i=0;i<GAME_PLAYER;i++)
			{
				...
				{
					GameEnd.lGameScore[i]=ScoreInfoArray[i].lScore-GameEnd.lGameScore[i]*m_pGameServiceOption->cbRevenue/100L;
					ScoreInfoArray[i].lRevenue=GameEnd.lGameScore[i]*m_pGameServiceOption->cbRevenue/100L;
				}
