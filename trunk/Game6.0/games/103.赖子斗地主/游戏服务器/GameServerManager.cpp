...
{
	//设置属性
	m_GameServiceAttrib.wKindID=456;
	...
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("赖子斗地主(1张)游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("LandLaizi.exe"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("LandLaiziServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
