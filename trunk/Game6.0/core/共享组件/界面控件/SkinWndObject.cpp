...
//宏定义
#define DEF_INSIDEBORDER_COLOR		RGB(85,132,174)						//默认颜色
#define DEF_BACKFRAME_COLOR			RGB(229,242,255)					//默认颜色
#define DEF_BACKGROUND_COLOR		RGB(229,242,255)					//默认颜色
#define DEF_CAPTIONTX_COLOR			RGB(200,200,200)					//默认颜色
