...
//数据库名字
const TCHAR szGameUserDB[]=TEXT("UserDB");								//用户数据库
const TCHAR	szTreasureDB[]=TEXT("GameTreasureDB");						//财富数据库
const TCHAR szServerInfoDB[]=TEXT("GameServerInfoDB");					//房间数据库
