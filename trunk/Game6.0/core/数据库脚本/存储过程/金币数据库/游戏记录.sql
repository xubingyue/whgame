...
BEGIN
	...
	-- 插入记录
	INSERT RecordGameScore (KindID, ServerID, TableID, RevenueCount, WasteCount, PlayTimeCount, UserID1, GameScore1, UserID2, GameScore2,
		UserID3, GameScore3, UserID4, GameScore4, UserID5, GameScore5, UserID6, GameScore6, UserID7, GameScore7, UserID8, GameScore8)
	VALUES (@wKindID, @wServerID, @wTableID, @lRevenueCount, @lWasteCount, @dwPlayTimeCount, @dwUserID1, @lGameScore1, @dwUserID2, @lGameScore2,
		@dwUserID3, @lGameScore3, @dwUserID4, @lGameScore4, @dwUserID5, @lGameScore5, @dwUserID6, @lGameScore6, @dwUserID7, @lGameScore7, @dwUserID8, @lGameScore8)
