...
#define DTP_USER_GOLD					209								//用户金币
#define DTP_USER_SCORE					210								//用户分数
#define DTP_USER_PLAY_COUNT				211								//总局盘数
#define DTP_USER_EXPERIENCE				212								//用户经验
#define DTP_GAME_LEVEL					213								//游戏等级
#define DTP_COMMUNITY_LEVEL				214								//社区等级
