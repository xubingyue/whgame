...
#ifdef VIDEO_GAME
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT( "GameLandVDDB" ),CountArray(m_GameServiceAttrib.szDataBaseName));	
...
#else
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT( "GameLandDB" ),CountArray(m_GameServiceAttrib.szDataBaseName));	
