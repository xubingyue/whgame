...
//启动服务
void CCenterServerDlg::OnBnClickedBeginService()
{
	if (m_CenterService.BeginService()==true)
	{
...
//停止服务
void CCenterServerDlg::OnBnClickedEndService()
{
	if (m_CenterService.EndService()==true)
	{
