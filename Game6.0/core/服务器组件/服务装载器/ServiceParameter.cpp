...
void CServiceParameter::OnOK()
{
	...
	//站点标识
	OptionParameter.GameServiceOption.wStationID=GetDlgItemInt(IDC_STATION_ID,NULL,FALSE);
	...
	//游戏税收
	OptionParameter.GameServiceOption.cbRevenue=GetDlgItemInt(IDC_REVENUE,NULL,FALSE);
	OptionParameter.GameServiceOption.cbRevenue=__min(OptionParameter.GameServiceOption.cbRevenue,100);
...
void CServiceParameter::ResetParameter()
{
	...
	//游戏税收
	m_OptionParameter.GameServiceOption.cbRevenue=5;
...
void CServiceParameter::UpdateOptionParameter()
{
	...
	//站点标识
	if (m_OptionParameter.GameServiceOption.wStationID==0) SetDlgItemText(IDC_STATION_ID,TEXT(""));
	else SetDlgItemInt(IDC_STATION_ID,m_OptionParameter.GameServiceOption.wStationID,FALSE);
	...
	//游戏税收
	SetDlgItemInt(IDC_REVENUE,m_OptionParameter.GameServiceOption.cbRevenue);
	...
	//服务地址
	CComboBox * pServerAddr=(CComboBox *)GetDlgItem(IDC_SERVER_ADDR);
	int nItemCount=pServerAddr->GetCount(),i=0;
