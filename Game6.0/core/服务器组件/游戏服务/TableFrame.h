...
public:
	//写入积分
	virtual bool __cdecl WriteUserScore(WORD wChairID, LONG lScore, LONG lRevenue, enScoreKind ScoreKind);
	//写入积分
	virtual bool __cdecl WriteUserScore(IServerUserItem * pIServerUserItem, LONG lScore, LONG lRevenue, enScoreKind ScoreKind);
...
public:
	...
	//锁定状态
	virtual bool __cdecl IsTableLocked() { return (m_szPassword[0]!=0); }
	//游戏状态
