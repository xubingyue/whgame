...
#include "..\..\服务器组件\内核组件\ServerKernel.h"
...
//时间常量
#define RANGE_TABLE_TIME				50									//标识范围
...
public:
	//写入积分
	virtual bool __cdecl WriteUserScore(WORD wChairID, LONG lScore, LONG lRevenue, enScoreKind ScoreKind)=NULL;
	//写入积分
	virtual bool __cdecl WriteUserScore(IServerUserItem * pIServerUserItem, LONG lScore, LONG lRevenue, enScoreKind ScoreKind)=NULL;
};
...
#ifdef _UNICODE
	#define VER_ITableFrameControl INTERFACE_VERSION(1,1)
...
public:
	...
	//启动服务
	virtual bool __cdecl BeginService()=NULL;
...
public:
	//脉冲事件
	virtual bool __cdecl OnEventTimerPulse(WORD wTimerID, WPARAM dwBindParameter)=NULL;
...
//////////////////////////////////////////////////////////////////////////
	...
	static const GUID IID_IGameServiceManager={0xd5bdced3,0xfecd,0x450b,0xa8,0x63,0xe8,0xef,0x55,0x54,0x6f,0x40};
#else
	#define VER_IGameServiceManager INTERFACE_VERSION(1,1)
	static const GUID IID_IGameServiceManager={0x27052abc,0x3f1a,0x4369,0x98,0x24,0x8f,0x94,0x1f,0xae,0x98,0x3f};
#endif
...
interface IGameService : public IUnknownEx
{
	...
	//开始服务
	virtual bool __cdecl BeginService(tagGameServiceParameter * pGameServiceParameter)=NULL;
	//停止服务
	virtual bool __cdecl EndService()=NULL;
};
