...
BEGIN
	...
	-- 注册用户
	INSERT AccountsInfo (Accounts,RegAccounts,LogonPass,InsurePass,EMail,Gender,FaceID,MachineSerial,GameLogonTimes,RegisterIP,LastLogonIP)
	VALUES (@strAccounts,@strAccounts,@strPassword,@strPassword,@strEMail,@cbGender,@wFaceID,@strMachineSerial,1,@strClientIP,@strClientIP)
	...
	SELECT @UserID=UserID, @Accounts=Accounts, @UnderWrite=UnderWrite, @Gender=Gender, @FaceID=FaceID, @Experience=Experience,
		@MemberOrder=MemberOrder, @MemberOverDate=MemberOverDate
