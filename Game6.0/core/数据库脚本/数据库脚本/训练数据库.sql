USE [master]
GO
/****** 对象:  Database [GameEducateDB]    脚本日期: 01/23/2008 14:55:34 ******/
IF NOT EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'GameEducateDB')
BEGIN
CREATE DATABASE [GameEducateDB]
END

GO
ALTER DATABASE [GameEducateDB] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [GameEducateDB] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [GameEducateDB] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [GameEducateDB] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [GameEducateDB] SET ARITHABORT OFF 
GO
ALTER DATABASE [GameEducateDB] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [GameEducateDB] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [GameEducateDB] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [GameEducateDB] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [GameEducateDB] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [GameEducateDB] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [GameEducateDB] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [GameEducateDB] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [GameEducateDB] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [GameEducateDB] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [GameEducateDB] SET  READ_WRITE 
GO
ALTER DATABASE [GameEducateDB] SET RECOVERY FULL 
GO
ALTER DATABASE [GameEducateDB] SET  MULTI_USER 
GO
if ( ((@@microsoftversion / power(2, 24) = 8) and (@@microsoftversion & 0xffff >= 760)) or 
		(@@microsoftversion / power(2, 24) >= 9) )begin 
	exec dbo.sp_dboption @dbname =  N'GameEducateDB', @optname = 'db chaining', @optvalue = 'OFF'
 end

USE [GameEducateDB]
GO
/****** 对象:  Table [dbo].[AndroidUserInfo]    脚本日期: 01/23/2008 14:56:55 ******/
SET ANSI_NULLS ON
GO
...
/****** 对象:  Index [IX_AndroidUserInfo_CreateDate]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_AndroidUserInfo_KindID]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_AndroidUserInfo_ServerID]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_AndroidUserInfo_UserID]    脚本日期: 01/23/2008 14:56:55 ******/
...
GO
/****** 对象:  Table [dbo].[ConfineAddress]    脚本日期: 01/23/2008 14:56:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** 对象:  Index [IX_ConfineAddress_CollectDate]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_ConfineAddress_EnjoinOverDate]    脚本日期: 01/23/2008 14:56:55 ******/
...
GO
/****** 对象:  Table [dbo].[ConfineMachine]    脚本日期: 01/23/2008 14:56:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** 对象:  Index [IX_MachineConfineRule_CollectDate]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_MachineConfineRule_EnjoinOverDate]    脚本日期: 01/23/2008 14:56:55 ******/
...
GO
/****** 对象:  Table [dbo].[GameScoreInfo]    脚本日期: 01/23/2008 14:56:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** 对象:  Table [dbo].[RecordGameScore]    脚本日期: 01/23/2008 14:56:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** 对象:  Index [IX_GameScoreRecord_KindID]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_GameScoreRecord_RecordDate]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_GameScoreRecord_ServerID]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_GameScoreRecord_TableID]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_GameScoreRecord_UserID1]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_GameScoreRecord_UserID2]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_GameScoreRecord_UserID3]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_GameScoreRecord_UserID4]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_GameScoreRecord_UserID5]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_GameScoreRecord_UserID6]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_GameScoreRecord_UserID7]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_GameScoreRecord_UserID8]    脚本日期: 01/23/2008 14:56:55 ******/
...
GO
/****** 对象:  Table [dbo].[RecordUserEnter]    脚本日期: 01/23/2008 14:56:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** 对象:  Index [IX_RecordUserEnter_EnterTime]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_RecordUserEnter_KindID]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_RecordUserEnter_ServerID]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_RecordUserEnter_UserID]    脚本日期: 01/23/2008 14:56:55 ******/
...
GO
/****** 对象:  Table [dbo].[RecordUserLeave]    脚本日期: 01/23/2008 14:56:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** 对象:  Index [IX_RecordUserLeave_KindID]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_RecordUserLeave_LeaveTime]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_RecordUserLeave_ServerID]    脚本日期: 01/23/2008 14:56:55 ******/
...
/****** 对象:  Index [IX_RecordUserLeave_UserID]    脚本日期: 01/23/2008 14:56:55 ******/
...
GO
/****** 对象:  Table [dbo].[SystemStreamInfo]    脚本日期: 01/23/2008 14:56:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
